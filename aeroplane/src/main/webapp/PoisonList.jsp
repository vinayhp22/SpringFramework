		...
		<table style="width: 100%;" class="table table-striped">
			...
			<tbody>
				...
				<tr style="color: red;">
					...
					<td><del>${dto.id}</del></td>
					<td><del>${dto.company}</del></td>
					<td><del>${dto.name}</del></td>
					<td><del>${dto.cost}</del></td>
					<td><del>${dto.type}</del></td>
					<td><del>${dto.country}</del></td>
					<td><h4>Data is Deleted?</h4></td>
					<td><h4>${dto!=null} <br> ${update}</h4></td>
